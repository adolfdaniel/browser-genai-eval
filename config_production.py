...
# Dataset Configuration (same as development)
AVAILABLE_DATASETS = {
    'cnn_dailymail': {
        'name': 'CNN/DailyMail',
...
# Default dataset
DEFAULT_DATASET = 'sample'  # Use sample as default for production
DATASET_NAME = "sample"
DATASET_VERSION = None
DATASET_SPLIT = None
MAX_ARTICLE_LENGTH = 4000
DEFAULT_MAX_ARTICLES = 10   # Reduced for production
MAX_ALLOWED_ARTICLES = 25   # Reduced for production
...
# File Paths (use /tmp for Azure App Service)
RESULTS_DIR = os.environ.get('RESULTS_DIR', '/tmp/results')
EXPORT_FILENAME_FORMAT = 'summarization_results_{timestamp}.csv'

# UI Configuration
LOG_MAX_ENTRIES = 500  # Reduced for production
PROGRESS_UPDATE_INTERVAL = 2

# Sample Articles (same as development)
SAMPLE_ARTICLES = [
    {
        'id': 1,
        'article': """
